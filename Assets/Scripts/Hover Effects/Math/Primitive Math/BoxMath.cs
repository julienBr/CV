...
namespace HoverEffectsPro
{
    ...
    public static class BoxMath
    {
        ...
        public static BoxFaceDesc GetFaceDesc(BoxFace boxFace, Vector3 boxCenter, Vector3 boxSize, Quaternion boxRotation)
        {
            var faceDesc = new BoxFaceDesc();
            ...
            switch (boxFace)
            {
                case BoxFace.Front:
                    ...
                    faceDesc.Plane = new Plane(-lookAxis, boxCenter - lookAxis * extents.z);
                    faceDesc.Center = boxCenter - lookAxis * extents.z;
                    return faceDesc;
                ...
                case BoxFace.Left:
                    ...
                    faceDesc.Plane = new Plane(-rightAxis, boxCenter - rightAxis * extents.x);
                    faceDesc.Center = boxCenter - rightAxis * extents.x;
                    return faceDesc;
                ...
                case BoxFace.Bottom:
                    ...
                    faceDesc.Plane = new Plane(-upAxis, boxCenter - upAxis * extents.y);
                    faceDesc.Center = boxCenter - upAxis * extents.y;
                    return faceDesc;
        ...
        public static bool Raycast(Ray ray, Vector3 boxCenter, Vector3 boxSize, Quaternion boxRotation)
        {
            float t;
            return Raycast(ray, out t, boxCenter, boxSize, boxRotation);
        }

        public static bool Raycast(Ray ray, out float t, Vector3 boxCenter, Vector3 boxSize, Quaternion boxRotation)
        {
            t = 0.0f;
