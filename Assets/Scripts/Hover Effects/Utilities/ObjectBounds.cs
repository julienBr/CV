    ...
    public static class ObjectBounds
    {
        ...
        public static AABB CalcModelAABB(GameObject gameObject, QueryConfig queryConfig, GameObjectType objectType)
        {
            ...
            if (objectType == GameObjectType.Mesh)
            {
                ...
                if (meshFilter != null && meshFilter.sharedMesh != null) return new AABB(meshFilter.sharedMesh.bounds);
               
                SkinnedMeshRenderer skinnedMeshRenderer = gameObject.GetComponent<SkinnedMeshRenderer>();
                if (skinnedMeshRenderer != null && skinnedMeshRenderer.sharedMesh != null)
                {
                    if (queryConfig.UseSkinLocalBounds) return new AABB(skinnedMeshRenderer.localBounds);
                    return new AABB(skinnedMeshRenderer.sharedMesh.bounds);
                }
