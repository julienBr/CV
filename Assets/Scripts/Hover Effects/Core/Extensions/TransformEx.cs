...
namespace HoverEffectsPro
{
    public static class TransformEx
    {
        ...
        public static void ScaleLocalFromPivot(this Transform transform, Vector3 scaleFactor, Vector3 pivot)
        {
        ...
        public static void ScaleLocalFromPivot(this Transform transform, float scaleFactor, Vector3 pivot)
        {
            ...
            float rightOffset = Vector3.Dot(fromPivotToPos, right) * scaleFactor;
            float upOffset = Vector3.Dot(fromPivotToPos, up) * scaleFactor;
            float lookOffset = Vector3.Dot(fromPivotToPos, look) * scaleFactor;
        ...
        public static void SetLocalScaleFromPivot(this Transform transform, Vector3 localScale, Vector3 pivot)
        {
            ...
            Vector3 scaleFactor = Vector3.Scale(transform.localScale, oldScale.GetInverse());
        ...
        public static void SetRotationAroundPivot(this Transform transform, Quaternion rotation, Vector3 pivot)
        {
            Quaternion relativeRotation = QuaternionEx.GetRelativeRotation(transform.rotation, rotation);
            Vector3 fromPivotToPos = transform.position - pivot;

            transform.rotation = rotation;
            fromPivotToPos = relativeRotation * fromPivotToPos;
